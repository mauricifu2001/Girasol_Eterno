window.appConfig = {
    ...
    story: {
        ...
        museum: {
            eyebrow: "Sala de mis viernes contigo",
            title: "La sala que hice para mi Girasol Hermosa",
            message: "No quise dejar nuestros capitulos tirados por ahi. Preferi abrirte una entrada aparte, como si cada viernes contigo mereciera su propia cartelera.",
            reverseOrder: true,
            autoFeed: {
                enabled: false,
            ...
            defaultNote: "Otro viernes mio contigo guardado en esta sala.",
            ctaLabel: "Entrar a la sala",
            previewTitle: "La cartelera completa te espera adentro",
            previewMessage: "Quise que esto se sintiera mas como una taquilla abierta para ti que como una lista infinita en la misma pantalla.",
            introEyebrow: "La taquilla ya prendio sus luces",
            introTitle: "Mi Girasol Hermosa, esta sala ya te estaba esperando",
            introMessage: "Quise que entrar aqui se sintiera como abrir una sala hecha por mi para nosotros, con luces, telon y esa sensacion de que nuestros viernes ya merecian su propia cartelera.",
            introTicketLabel: "Entrada reservada",
            introTicketName: "Mi Girasol Hermosa",
            introTicketMeta: "Funcion privada para nuestros viernes",
            introEnterLabel: "Abrir la sala",
            introSkipLabel: "Entrar sin espera",
            pageEyebrow: "Cartelera privada para ti",
            pageTitle: "La sala que hice para nuestros viernes",
            pageMessage: "Mi Girasol Hermosa, todos los capitulos que hemos visto juntos viven aqui como una taquilla encendida solo para nosotros, para que cada viernes tenga donde quedarse.",
            pageStatLabel: "Capitulos en cartelera",
            pageStatNote: "Cada titulo me devuelve a uno de nuestros viernes.",
            stripEyebrow: "Titulares de nuestra cartelera",
            stripTitle: "Los viernes que ya se volvieron parte de lo nuestro",
            galleryEyebrow: "Cartelera completa",
            galleryTitle: "Todos los capitulos guardados para mi Girasol Hermosa",
            backButtonLabel: "Volver al portal",
            galleryButtonLabel: "Ver cartelera",
            galleryBackLabel: "Regresar al portal",
            premiereEyebrow: "La funcion mas reciente para ti",
            premiereButtonLabel: "Ver la funcion dentro de la sala",
            premiereExternalLabel: "Abrir la funcion en YouTube",
            entries: [
                // Ejemplo de tarjeta:
                // {
